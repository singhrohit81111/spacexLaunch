...
export default function Upcoming() {
    ...
    const getSpaceData=fetch('https://api.spacexdata.com/v5/launches/upcoming')
  ...
  return (
    ...
    <div className="appBar">
      <div className="ins">
        <div className="left">
         <button className='upcomingHovers' onClick={handleClick1}>All</button>
         <button className='upcomingHovers' onClick={handleClick2}>Past</button>
         <button style={{backgroundColor:'#55525e'}}>Upcoming</button>
        </div>
        <div className="right">
