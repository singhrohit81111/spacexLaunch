...
export default function Past() {
    ...
    const getSpaceData=fetch('https://api.spacexdata.com/v5/launches/past')
  ...
  return (
    ...
    <div className="appBar">
      <div className="ins">
        <div className="left">
         <button className='pastHovers' onClick={handleClick1}>All</button>
         <button style={{backgroundColor:'#55525e'}}>Past</button>
         <button className='pastHovers' onClick={handleClick2}>Upcoming</button>
        </div>
        <div className="right">
